...
public interface ISqlExecutor
{
    ...
    Task<T?> QuerySingleAsync<T>(string connection, string sql, object? param = null, int? timeoutSeconds = null);
    ...
    Task<T?> QuerySingleAsync<T>(IDbConnection connection, string sql, object? param = null, IDbTransaction? transaction = null, int? timeoutSeconds = null);
}
